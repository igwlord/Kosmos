...
export function Installation() {
  ...
  return (
    <section className="w-full max-w-4xl px-panel-margin py-32 mb-12" id="installation">
      <div
        ref={ref}
        className={`glass-panel rounded-2xl p-10 border border-white/10 relative overflow-hidden transition-all duration-700 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
      >
        ...
        <div className="flex items-center gap-4 mb-10 pb-6 border-b border-white/5">
          ...
          <div>
            <h2 className="font-display-lg text-headline-md text-on-surface">{t.installation.heading}</h2>
