...
function InstallNote({ children }: { children: ReactNode }) {
  return (
    <div className="mt-3 flex items-start gap-2 rounded-lg border border-secondary/20 bg-secondary/5 px-3 py-2.5 text-xs md:text-[13px] text-on-surface-variant leading-relaxed">
      <span className="material-symbols-outlined text-secondary text-base shrink-0 mt-0.5" aria-hidden="true">info</span>
      <span>{children}</span>
    </div>
  );
}
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3 md:gap-4 mb-6 md:mb-8 pb-4 md:pb-6 border-b border-white/5">
          <div className="w-12 h-12 shrink-0 rounded-xl bg-tertiary/10 flex items-center justify-center border border-tertiary/20">
            <span className="material-symbols-outlined text-tertiary text-3xl" aria-hidden="true">download_done</span>
          </div>
          <div>
        ...
        <div className="relative z-10 mb-8 md:mb-12 rounded-xl border border-primary/30 bg-gradient-to-r from-primary/10 via-secondary-container/5 to-tertiary/10 p-4 md:p-5 flex items-center gap-3 md:gap-4 overflow-hidden">
          <span className="material-symbols-outlined text-primary text-2xl md:text-3xl shrink-0" aria-hidden="true">bolt</span>
        ...
        <div className="relative grid grid-cols-1 gap-8 md:gap-10">
          ...
          <div className="flex gap-4 md:gap-6 group relative z-10">
            ...
            <div className="pt-1 flex-1 min-w-0">
              <h3 className="font-headline-md text-on-surface mb-2">{t.installation.step1.title}</h3>
          ...
          <div className="flex gap-4 md:gap-6 group relative z-10">
            ...
            <div className="pt-1 flex-1 min-w-0">
              <h3 className="font-headline-md text-on-surface mb-4">{t.installation.step2.title}</h3>
          ...
          <div className="flex gap-4 md:gap-6 group relative z-10">
            ...
            <div className="pt-1 flex-1 min-w-0">
              <h3 className="font-headline-md text-on-surface mb-2">{t.installation.step3.title}</h3>
              <p className="font-body-base text-on-surface-variant mb-4">{t.installation.step3.body}</p>
              <ul className="space-y-3">
                <li className="flex flex-wrap items-center gap-2 text-sm">
                  <span className="font-label-caps text-[11px] tracking-wider text-primary bg-primary/10 border border-primary/20 rounded-md px-2 py-1 shrink-0">VST3</span>
                  <span className="text-on-surface-variant">
                    <span className="text-on-surface">{t.installation.step3.daw1Name}</span> — {t.installation.step3.daw1Detail}
                  </span>
                </li>
                <li className="flex flex-wrap items-center gap-2 text-sm">
                  <span className="font-label-caps text-[11px] tracking-wider text-tertiary bg-tertiary/10 border border-tertiary/20 rounded-md px-2 py-1 shrink-0">AU</span>
                  <span className="text-on-surface-variant">
                    <span className="text-on-surface">{t.installation.step3.daw2Name}</span> — {t.installation.step3.daw2Detail}
                  </span>
                </li>
                <li className="flex flex-wrap items-center gap-2 text-sm">
                  <span className="font-label-caps text-[11px] tracking-wider text-secondary bg-secondary/10 border border-secondary/20 rounded-md px-2 py-1 shrink-0">STANDALONE</span>
